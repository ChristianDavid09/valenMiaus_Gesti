...
CREATE TABLE IF NOT EXISTS `adopciones` (
    ...
    estado ENUM('En proceso', 'Completada', 'Cancelada') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `atencion_cliente` (
    ...
    tipo_solicitud ENUM('Consulta', 'Sugerencia', 'Reclamo') NOT NULL,
    estado ENUM('Pendiente', 'Resuelto', 'Cerrado') NOT NULL,
